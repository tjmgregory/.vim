...
nnoremap <leader>stt :read $HOME/.vim/snippets/test_sync.ts<CR>:Format<CR>^
nnoremap <leader>sta :read $HOME/.vim/snippets/test_async.ts<CR>:Format<CR>^
nnoremap <leader>std :read $HOME/.vim/snippets/test_describe.ts<CR>:Format<CR>^
